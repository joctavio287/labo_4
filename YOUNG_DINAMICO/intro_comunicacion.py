# codigo básico de comunicacion con instrumentos (osciloscopio y generador de funciones)
# de Diego Shalom
# https://github.com/diegoshalom/labosdf/blob/master/software/python/Labo5%202021
